        ...
        return CommandSpec.builder()
                ...
                .executor((src, args) -> {
                    if (!(src instanceof Player)) {
                        ...
                        player.sendMessage(RPUtil.toText(RedProtect.get().lang.get("playerlistener.wand1") + RedProtect.get().lang.get("general.color") + " (&6" + pl.getBlockX() + RedProtect.get().lang.get("general.color") + ", &6" + pl.getBlockY() + RedProtect.get().lang.get("general.color") + ", &6" + pl.getBlockZ() + RedProtect.get().lang.get("general.color") + ")."));
